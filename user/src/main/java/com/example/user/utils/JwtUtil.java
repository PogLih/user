...
//    Date jwtExpiredAt = DateUtil.plusOrMinus(issueAt,
//        jwtTokenProperties.getTtlInSecond() == null ? 3600 : jwtTokenProperties.getTtlInSecond(),
//        ChronoUnit.SECONDS);
//    Date refreshTokenExpiredAt = DateUtil.plusOrMinus(issueAt,
//        refreshTokenProperties.getTtlInSecond() == null ? 3600
...
//        .user(user)
//        .expiredAt(OffsetDateTime.now().plusSeconds(
//            jwtTokenProperties.getTtlInSecond() == null ? 3600
//                : jwtTokenProperties.getTtlInSecond()))
...
//    if (jwtTokenProperties.getType() == null || jwtTokenProperties.getType().equals("Symmetric")) {
//      return jwtBuilder.signWith(getSecretKey(user.getPassword(), token));
//    } else if (jwtTokenProperties.getType().equals("Asymmetric")) {
...
//    if (jwtTokenProperties.getSecretKeyPath() == null) {
//
//    }
//    byte[] keyBytes =
